...
class HelloWorldApi(remote.Service):
    ...
    def say_hello_by_name(self, request):
      greet = "This is a great hello from the server to {}".format(request.name)
      return Hello(greeting=greet)

    @endpoints.method(REQUEST_CONTAINER, Hello, path="sayHelloWithAge", http_method='GET', name="sayHelloWithAge")
    def say_hello_with_age(self, request):
